...
def scores(data_config, model, device):
    ...
    print(f'f1_socre: {f1_score(true, preds, average="macro")}')
    print(f'precision_socre: {precision_score(true, preds, average="macro")}')
    print(f'recall_socre: {recall_score(true, preds, average="macro")}')
